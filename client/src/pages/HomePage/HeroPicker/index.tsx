...
const HeroPicker: FC<{ onHeroPicked: (hero: Hero) => void, disabled: boolean, heroes: Hero[], loading: boolean}> = ({ onHeroPicked, disabled, heroes, loading }) => {
  ...
  return (
    <Select isLoading={loading} options={options} onChange={handleChange} value={null} isClearable={false} isDisabled={disabled} />
  );
}
